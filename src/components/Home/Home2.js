        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
             Programming and Problem Solving is a passion of mine since an early age .

              <br />
              <br />Proficient in foundational languages such as 
              <i>
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/amine-lahouani-5220881a0/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
